...
inputs:
  - name: target
    type: string
    description: What to review — defaults to staged/unstaged changes. Supports --diff <ref> or --file <path>.
    required: false
outputs:
  - name: review_report
    type: ref
    format: markdown
    description: Structured adversarial review with severity-classified findings and a BLOCK/CONCERNS/CLEAN verdict
---
