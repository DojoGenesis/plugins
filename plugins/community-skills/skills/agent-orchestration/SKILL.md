...
description: "Spawn implementation agents to preserve main context instead of doing heavy work inline. Use when implementing features that would burn context. Trigger phrases: \"use an agent\", \"preserve context\", \"spawn implementation agent\"."
