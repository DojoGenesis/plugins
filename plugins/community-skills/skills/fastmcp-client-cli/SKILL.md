...
description: Query and invoke tools on MCP servers using fastmcp list and fastmcp call. Use when you need to discover what tools a server offers, call tools, or integrate MCP servers into workflows. Trigger phrases: "query and invoke tools on mcp servers using fastmcp list and fastmcp call".
