...
description: "Manage Git worktrees for parallel feature development with port allocation, env sync, and cleanup. Use when running multiple branches simultaneously. Trigger phrases: \"create worktree\", \"parallel branches\", \"isolated dev environment\"."
---
