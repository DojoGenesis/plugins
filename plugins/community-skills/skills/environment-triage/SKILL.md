...
description: "Diagnose Python environment mismatches between system Python, uv, and venv interpreters. Use when pip install or uv sync behaves unexpectedly. Trigger phrases: \"wrong python version\", \"uv sync failing\", \"environment mismatch\"."
