---
name: gh-cli
description: Enforces authenticated gh CLI workflows over unauthenticated curl/WebFetch patterns. Use when working with GitHub URLs, API access, pull requests, or issues. Trigger phrases: "enforces authenticated gh cli workflows over unauthenticated curl/webfetch patterns".
