---
name: fp-check
description: Systematically verifies suspected security bugs to eliminate false positives. Produces TRUE POSITIVE or FALSE POSITIVE verdicts with documented evidence for each bug. Trigger phrases: "systematically verifies suspected security bugs to eliminate false positives".
