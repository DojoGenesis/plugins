...
description: "Standard multi-agent pipeline using background agents with file-based outputs for research, implementation, and review stages. Use when orchestrating multi-step agent work. Trigger phrases: \"agentic pipeline\", \"multi-agent workflow\", \"agent orchestration pattern\"."
