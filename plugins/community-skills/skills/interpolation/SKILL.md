---
name: interpolation
description: Problem-solving strategies for interpolation in numerical methods. Trigger phrases: "problem-solving strategies for interpolation in numerical methods".
