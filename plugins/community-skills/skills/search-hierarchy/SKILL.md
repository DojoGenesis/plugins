...
description: "Pick the most token-efficient search tool per query type: AST-grep, LEANN, Grep, or Read. Use when minimizing search token cost. Trigger phrases: \"efficient code search\", \"reduce search tokens\", \"search decision tree\"."
