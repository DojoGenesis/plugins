...
description: 25 advanced engineering agent skills and plugins for Claude Code, Codex, Gemini CLI, Cursor, OpenClaw. Agent design, RAG, MCP servers, CI/CD, database design, observability, security auditing, release management, platform ops. Trigger phrases: "25 advanced engineering agent skills and plugins for claude code, codex, gemini cli, cursor, openclaw".
license: MIT
---
