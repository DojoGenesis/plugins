---
name: search-tools
description: "Route code searches to the optimal tool: LEANN for semantic, AST-grep for structural, Morph/Grep for text. Use when choosing a search strategy. Trigger phrases: \"which search tool\", \"find code pattern\", \"semantic vs text search\"."
