...
description: "Index artifacts immediately when created, not in deferred batches, so downstream logic can query them. Use when data must be searchable right away. Trigger phrases: \"index immediately\", \"artifact not queryable\", \"write-time indexing\"."
