---
name: root-finding
description: Problem-solving strategies for root finding in numerical methods. Trigger phrases: "problem-solving strategies for root finding in numerical methods".
