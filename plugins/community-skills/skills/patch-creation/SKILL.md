---
name: patch-creation
description: Create and register new patches for tweakcc. Use when adding new customizations to Claude Code. Trigger phrases: "create and register new patches for tweakcc".
