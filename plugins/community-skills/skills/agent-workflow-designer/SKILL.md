...
description: "Design multi-agent workflows with pattern selection, handoff contracts, failure handling, and cost controls. Use when a single prompt is insufficient for task complexity. Trigger phrases: \"design agent workflow\", \"multi-agent system\", \"agent handoff pattern\"."
---
