...
description: 23 engineering agent skills and plugins for Claude Code, Codex, Gemini CLI, Cursor, OpenClaw, and 6 more tools. Architecture, frontend, backend, QA, DevOps, security, AI/ML, data engineering, Playwright, Stripe, AWS, MS365. 30+ Python tools (stdlib-only). Trigger phrases: "23 engineering agent skills and plugins for claude code, codex, gemini cli, cursor, openclaw, and 6 more tools".
license: MIT
---
