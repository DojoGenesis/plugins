...
description: Creates new Agent Skills for Claude Code following best practices and documentation. Use when the user wants to create a new skill, extend Claude's capabilities, or package domain expertise into a reusable skill. Trigger phrases: "creates new agent skills for claude code following best practices and documentation".
