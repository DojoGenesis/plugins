...
description: "Security audits and vulnerability-scans AI agent skills before installation — detecting prompt injection, dangerous Python patterns (eval, subprocess, os.system), supply chain risks, and file system boundary violations. Use when: 'audit this skill', 'is this skill safe', 'scan skill for security', 'check skill before install', 'skill vulnerability scan'."
---
