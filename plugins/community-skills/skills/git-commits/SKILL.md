---
name: git-commits
description: "Use the /commit skill instead of raw git commit to remove AI attribution and capture reasoning. Use when committing, pushing, or saving changes. Trigger phrases: \"commit changes\", \"save to git\", \"push code\"."
