...
description: Diagnose and fix Claude in Chrome MCP extension connectivity issues. Use when mcp__claude-in-chrome__* tools fail, return "Browser extension is not connected", or behave erratically. Trigger phrases: "diagnose and fix claude in chrome mcp extension connectivity issues".
