...
description: "Run QLTY lint and format checks during development to catch issues early, not just before commit. Use after significant code changes. Trigger phrases: \"run linter\", \"check code quality\", \"format before commit\"."
