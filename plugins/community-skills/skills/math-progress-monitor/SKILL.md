...
description: Metacognitive check-ins during problem solving - detects when to pivot or persist. Trigger phrases: "metacognitive check-ins during problem solving - detects when to pivot or persist".
