---
name: pm-skills
description: 6 project management agent skills and plugins for Claude Code, Codex, Gemini CLI, Cursor, OpenClaw. Senior PM, scrum master, Jira expert (JQL), Confluence expert, Atlassian admin, template creator. MCP integration for live Jira/Confluence automation. Trigger phrases: "6 project management agent skills and plugins for claude code, codex, gemini cli, cursor, openclaw".
license: MIT
---
