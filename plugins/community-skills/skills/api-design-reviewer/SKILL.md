...
description: "Review API designs for REST conventions, breaking changes, and consistency with automated linting and scorecards. Use when designing or evolving APIs. Trigger phrases: \"review API design\", \"check for breaking changes\", \"API linting\"."
---
