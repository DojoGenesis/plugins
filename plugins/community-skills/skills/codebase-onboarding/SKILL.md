...
description: "Analyze a codebase and generate onboarding docs covering architecture, key files, local setup, and contribution guides. Use when onboarding new engineers. Trigger phrases: \"onboard to this repo\", \"generate onboarding guide\", \"explain this codebase\"."
---
