...
description: "Profile CPU, memory, and I/O bottlenecks in Node.js, Python, and Go apps with flamegraphs and load tests. Use when diagnosing slow endpoints or memory leaks. Trigger phrases: \"profile performance\", \"find bottleneck\", \"memory leak detection\"."
---
