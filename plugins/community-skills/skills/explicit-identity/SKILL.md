...
description: "Pass explicit IDs through async and process boundaries instead of querying for 'latest' or 'current'. Use when crossing process or async boundaries. Trigger phrases: \"race condition on ID\", \"pass session ID\", \"explicit identifier\"."
