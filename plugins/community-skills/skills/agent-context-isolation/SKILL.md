...
description: "Prevent sub-agent output from polluting the main context window using background execution and file-based results. Use when agent transcripts bloat context. Trigger phrases: \"isolate agent context\", \"context window bloat\", \"agent output too large\"."
