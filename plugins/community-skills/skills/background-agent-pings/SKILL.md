...
description: "Trust system reminders as agent progress notifications instead of polling for completion. Use when waiting on background agents. Trigger phrases: \"agent still running\", \"check agent progress\", \"stop polling agents\"."
