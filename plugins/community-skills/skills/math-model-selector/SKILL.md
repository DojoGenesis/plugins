...
description: Routes problems to appropriate mathematical frameworks using expert heuristics. Trigger phrases: "routes problems to appropriate mathematical frameworks using expert heuristics".
