...
description: "Prevent type duplication across parallel agents by requiring grep-before-create and tsc verification. Use when launching parallel code implementation agents. Trigger phrases: \"parallel type conflicts\", \"duplicate interface\", \"agent type contract\"."
