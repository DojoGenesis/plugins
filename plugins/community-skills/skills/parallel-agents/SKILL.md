...
description: "Launch multiple agents in parallel with file-based coordination and context isolation. Use when spawning concurrent background agents. Trigger phrases: \"run agents in parallel\", \"launch background agents\", \"parallel task delegation\"."
