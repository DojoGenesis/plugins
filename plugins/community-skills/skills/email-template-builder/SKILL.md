...
description: "Build transactional email systems with React Email/MJML templates, provider integration, i18n, and dark mode. Use when implementing email notifications. Trigger phrases: \"build email template\", \"transactional email\", \"email provider setup\"."
---
