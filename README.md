...
**1.5.4** — 101 first-party skills organized into 12 semantic clusters, published as the `dojo-genesis` marketplace. Cluster membership is metadata-only; skills are never moved between plugins (invoke-name stability).
